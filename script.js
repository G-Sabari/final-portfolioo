...
function initSkillGalaxy() {
  ...
  const SKILLS = [
    ...
    { name:'Spring Boot',       color:'#00d4ff', r:32 }
  ];
...
function initSkillGrid() {
  ...
  const SKILLS = [
    ...
    { name:'JavaScript', img:'https://cdn-icons-png.flaticon.com/512/5968/5968292.png',pct:'85%' },
...
function initContact() {
  ...
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
  const EMAILJS_PUBLIC_KEY  = '1y4BAxPj5CvYl3Wpa';   // e.g. 'user_xxxxxxxxxxxx'
